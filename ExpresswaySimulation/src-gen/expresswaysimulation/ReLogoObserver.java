...
public class ReLogoObserver extends BaseObserver{
	...
	public AgentSet<expresswaysimulation.relogo.UserTurtle> createUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("expresswaysimulation.relogo.UserTurtle")
	public AgentSet<expresswaysimulation.relogo.UserTurtle> createUserTurtles(int number) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("expresswaysimulation.relogo.UserTurtle")
	public AgentSet<expresswaysimulation.relogo.UserTurtle> createOrderedUserTurtles(int number, Closure closure) {
		AgentSet<expresswaysimulation.relogo.UserTurtle> result = new AgentSet<>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("expresswaysimulation.relogo.UserTurtle")
	public AgentSet<expresswaysimulation.relogo.UserTurtle> createOrderedUserTurtles(int number) {
	...
	public AgentSet<expresswaysimulation.relogo.UserTurtle> userTurtles(){
		...
		for (Object e : this.getContext().getObjects(expresswaysimulation.relogo.UserTurtle.class)) {
	...
	public AgentSet<expresswaysimulation.relogo.UserLink> userLinks(){
		...
		for (Object e : this.getContext().getObjects(expresswaysimulation.relogo.UserLink.class)) {
	...
	public expresswaysimulation.relogo.UserLink userLink(Number oneEnd, Number otherEnd) {
		return (expresswaysimulation.relogo.UserLink)(this.getNetwork("UserLink").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
